...
| Adaptive policy engines (`backend/src/services/adaptive-retention.service.ts`, `backend/src/services/short-loop-policy.service.ts`) | FSRS/Algorithm | Learning Platform | Study oncall | Rollout guarded by feature flags |
