      ...
      <div className="mc-study-surface w-full max-w-sm space-y-6 rounded-xl border p-6 shadow-sm">
        ...
        {sent ? (
          <div className="space-y-4">
            ...
            <Link
              href={`/${locale}/login`}
              className={buttonClassName({ variant: 'brand', className: 'w-full justify-center text-center' })}
            >
              {backToLogin}
            </Link>
          </div>
          ...
          <>
            ...
            <p className="text-center text-sm text-(--mc-text-secondary)">
              <Link href={`/${locale}/login`} className="font-medium text-(--mc-accent-primary)">{backToLogin}</Link>
            </p>
          </>
        )}
      </div>
